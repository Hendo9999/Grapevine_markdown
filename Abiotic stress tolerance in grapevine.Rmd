...
```{r standard-plot3, out.width='60%', fig.align='center', fig.height= 8, fig.width=15, fig.cap="Comparison of biological reps"}
...
```{r standard-plot5, out.width='60%', fig.align='center', fig.height=8, fig.width=10, fig.cap="Comparison of biological reps"}
...
```{r standard-plot6, out.width='60%', fig.align='center', fig.height=8, fig.width=15, fig.cap="Leaf chloride content in each grapevine line"}

#compare effects of heat and salt treatments

#combined treatments into a single column and combined bio_reps
plot_100 <- chloride_4_tidy %>%
  ggplot(aes(x=reorder(genotype_id, cl_dry_weight_calc, FUN = median), y=cl_dry_weight_calc, colour = treatment))+
...
It quickly became apparent that utilising R effectively requires a flexible mindset in trying and using tools available in R packages outside of the tidyverse. In my analyses, I used tools available in the following packages:
