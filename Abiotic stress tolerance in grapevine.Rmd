...
# Introduction
I am located in Agriculture and Food at the Waite Campus, Adelaide. Looking back through the annals of time, I suppose I have a fairly broad background in various fields such as fungal genetics, human biochemistry, and cancer proteomics. In the last ten years, I was primarily involved in the use of plant molecular genetics to isolate the causal loci for apomixis (the process of asexual reproduction through seed). I am currently transitioning into grapevine research for viticulture and am involved in a project investigating genetic and mechanistic aspects of abiotic stress in grapevines. Data School has been a steep learning curve for me as I had no prior coding experience, and previous bioinformatic tasks I had directly undertaken typically involved GUI based software such as Geneious and Excel.

# My Project
The dataset used is chloride ion measurements in the leaves of a segregating grapevine mapping population subjected to salt and/or heat treatments. This chloride analysis is a subset of a substantially larger experiment investigating abiotic stress which includes state of the art imaging analysis in a plant accelerator to determine growth rates and water usage. The ultimate goal is to be able to use R as a more rigourous and effective analysis pipeline for all aspects of the experiment. The immediate goals for this dataset in Data School: Focus was to evaulate the utility of R for analysing chloride data subset, and to identify potential sources of variation within the data. 
...
```{r standard-plot1, out.width='60%', fig.align='center', fig.height= 4, fig.width=6, fig.cap="Histogram showing skew in chloride dry weight measurements"}

hist(cl_dry_weight_calc, main = " ", xlab = "Leaf chloride dry weight (mg)")
```


**Plots from R**
```{r standard-plot2, out.width='60%', fig.align='center', fig.height= 4, fig.width=6, fig.cap="QQ Norm plot of leaf chloride dry weight"}
...
```{r standard-plot4, out.width='60%', fig.align='center', fig.height= 8, fig.width=5, fig.cap="Comparison of biological reps"}
...
```{r standard-plot5, out.width='60%', fig.align='center', fig.height=8, fig.width=5, fig.cap="Comparison of biological reps"}
...
```{r standard-plot6, out.width='100%', fig.align='center', fig.height= 10, fig.width=20, fig.cap="Comparison of biological reps"}
...
plot_2a <- chloride_3_tidy %>%
  ...
  geom_jitter(size = 2, alpha =0.5)+
  theme(axis.text.x=element_text(size=15, angle=45), axis.title=element_text(size=15), axis.text.y=element_text(size=15), legend.title = element_text(size=15), legend.text = element_text(size=15), legend.position = "bottom")+
...
plot_3a <- chloride_4_tidy %>%
  ggplot(aes(x=cl_sample_weight_mg, y = cl_dry_weight_calc, colour = treatment)) +
  geom_point(size = 2, alpha =0.5)+
  facet_wrap(~treatment)
plot_3a


#cl dry weight vs treatments
plot_3b <- chloride_3_tidy %>%
  ggplot(aes(x=treatment_salt, y = cl_dry_weight_calc, colour = treatment_heat)) +
  geom_jitter(size = 2, alpha =0.5)+
